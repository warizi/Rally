...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changes: [
      {
        type: 'fix',
        title: '탭이 많을 때 창 드래그 영역이 사라지던 문제 수정',
        description:
          '탭을 여러 개 열면 탭바 위쪽 몇 픽셀만 잡을 수 있던 문제를 수정했습니다. 이제 각 탭바 오른쪽에 탭 수와 무관하게 창을 끌 수 있는 공간이 항상 남습니다.'
      },
      {
        type: 'fix',
        title: '화면 분할 시 최소 너비가 안쪽 분할까지 반영되도록 수정',
        description:
          '한 열 안에서 좌우로 나눈 화면이 있어도 그 열이 화면 하나 크기까지 줄어들던 문제를 수정했습니다. 글자 크기 설정에 따라 최소 너비가 달라져 생기던 미세한 가로 스크롤도 함께 없앴습니다.'
      },
      {
        type: 'fix',
        title: '화면을 좁혔을 때 페이지 제목이 줄바꿈되던 문제 수정',
        description:
          '화면 너비가 최소일 때 페이지 제목이 두 줄로 꺾이거나 버튼과 겹치던 문제를 수정했습니다. 제목은 한 줄로 표시되고, 좁은 화면에서는 일부 버튼이 아이콘만 보입니다.'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    changes: [
      ...
      {
        type: 'feature',
        title: '터미널 탭 드래그로 순서 변경',
        description:
          '터미널 탭을 좌우로 드래그해서 순서를 바꿀 수 있습니다. 변경된 순서는 자동 저장되어 다음 실행 시에도 유지됩니다.'
      },
      {
        type: 'feature',
        title: '파일 탐색기 검색 기능',
  ...
  },
  {
    ...
    changes: [
      {
        type: 'feature',
        title: '유저 온보딩 — 환영 모달 + 빈 상태 가이드',
        description:
          '첫 실행 시 Rally를 30초 안에 파악할 수 있는 3-슬라이드 환영 모달이 표시됩니다. "샘플 워크스페이스 만들기"를 누르면 노트 4개 + 표 1개 + 캔버스 1개 + 할 일·서브 할 일 + 일정 + 태그가 자동 시드된 별도 워크스페이스가 생성되어 곧바로 둘러볼 수 있습니다. 대시보드·탐색기·할 일·캘린더가 비어 있을 때는 다음 액션을 안내하는 빈 상태 카드가 표시됩니다.'
      },
      {
        type: 'feature',
        title: '진행 체크리스트 + 컨텍스트 미니 팁',
        description:
          '대시보드 상단의 "시작하기" 위젯이 첫 노트·할 일·링크·캔버스 노드·태그·AI 등록·휴지통 진입 7단계를 추적하고, 모두 마치면 축하 토스트와 함께 자동 숨김됩니다. 할 일·캔버스·노트·휴지통·AI 설정 화면에는 작은 💡 도움말 아이콘이 추가되어, 처음 진입했을 때 핵심 사용법을 한 줄 팁으로 안내합니다. 설정 > 일반 > 온보딩 다시 보기에서 환영 모달과 체크리스트·팁을 모두 초기화할 수 있습니다.'
      }
    ]
  },
  {
    ...
    changes: [
      {
        type: 'fix',
        title: '업데이트 누락 적용',
        description: '1.6.0에서 업데이트 시 누락된 내용 적용'
      }
    ]
  },
  {
