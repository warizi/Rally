...
|------|--------|-------------|
| src/main/services/__tests__/note-image.test.ts | ✅ | New file with 32 test cases |
| src/main/services/__tests__/note.test.ts | ✅ | 4 test cases added to existing file |
