...
export function useDayDnd(options: {
  ...
  moveSchedule: (params: { scheduleId: string; startAt: Date; endAt: Date; workspaceId: string }) => void
  updateTodo: (params: { workspaceId: string; todoId: string; data: { startDate: Date; dueDate: Date } }) => void
}) {
  // 상태 4개 + 핸들러 3개 캡슐화
  return {
    activeSchedule, activeType, previewDelta, activeSize,
