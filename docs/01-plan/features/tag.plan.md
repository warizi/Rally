...
interface ItemTagAPI {
  ...
  attach: (itemType: TaggableEntityType, tagId: string, itemId: string) => Promise<IpcResponse<void>>
  detach: (itemType: TaggableEntityType, tagId: string, itemId: string) => Promise<IpcResponse<void>>
}
...
// queryKey
[TAG_KEY, 'workspace', workspaceId]           // 워크스페이스별 태그 목록
[ITEM_TAG_KEY, itemType, itemId]              // 아이템별 태그
